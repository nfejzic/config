return {
	...
	-- NOTE: this is not yet ready. In particular:
	--       - command auto-complete does not work
	--       - LSP Documentation during autocomplete is not rendered nicely as of right now
	-- {
	-- 	'saghen/blink.cmp',
